describe('Test functionality adding product into cart', () => {
    ...
    it("Add Gift card to cart from the list of products", () => {
        cy.get('div.bx > a[href*="/darkove-poukazy/"]')
            .click()

        cy.location("pathname")
            .should("contain", "/darkove-poukazy/")

        cy.get(".subCategories.cz > a[href*='/darkove-poukazy-alza/']")
            .click()

        cy.location("pathname").
            should("contain", "/gaming/darkove-poukazy-alza/")

        // add to cart
        cy.get("[data-code='AGbezCZ04']")
            .find(".btnk1")
            .click()
    ...
    it("Add Gift card to cart from product's detail", () => {
        cy.get('div.bx > a[href*="/darkove-poukazy/"]')
            .click()
        ...
        cy.get(".fb > a[data-impression-id='AGbezCZ03']")
            .click()
